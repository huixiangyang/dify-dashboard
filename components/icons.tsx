...
export const SparklesIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 3v5m0 13v-5m-5-4h5m8 0h-5m-6.5-.5l2 2m9-9l-2 2m0 9l-2-2m-9-9l2 2" />
    </svg>
  );
};

export const LightningIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export function DeleteIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
